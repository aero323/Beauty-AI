    ...
    <div className="space-y-6 flex-1 flex flex-col pt-2">
      <div className="flex items-center justify-between mb-4 bg-white p-4 rounded-xl shadow-sm border border-slate-100">
         <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-900">Toko Mal Kelapa Gading</h2>
              <p className="text-xs text-slate-500">Jakarta South District</p>
            </div>
         </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <Card className="rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
          <CardHeader className="p-5 pb-0">
            <CardTitle className="text-xs font-semibold text-slate-400 uppercase tracking-widest">本店 BA 编制</CardTitle>
          </CardHeader>
          <CardContent className="p-5 pt-2">
            <div className="flex items-end justify-between leading-none">
              <span className="text-3xl font-bold">5<span className="text-sm font-normal text-slate-400 ml-1">人</span></span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
          <CardHeader className="p-5 pb-0">
            <CardTitle className="text-xs font-semibold text-slate-400 uppercase tracking-widest">本店综合完课率</CardTitle>
          </CardHeader>
          <CardContent className="p-5 pt-2">
            <div className="flex items-end justify-between leading-none">
        ...
        <Card className="rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
          <CardHeader className="p-5 pb-0">
            <CardTitle className="text-xs font-semibold text-slate-400 uppercase tracking-widest">本店考试均分</CardTitle>
          </CardHeader>
          <CardContent className="p-5 pt-2">
            <div className="flex items-end justify-between leading-none">
              <span className="text-3xl font-bold text-amber-600">71.4</span>
              <span className="text-xs text-slate-400 italic mb-1">勉强及格</span>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="flex-1 flex flex-col space-y-6">
        <Tabs defaultValue="staff" className="w-full flex-1 flex flex-col min-h-[460px]">
          <TabsList className="w-full justify-start border-b rounded-none bg-transparent h-12 p-0">
            <TabsTrigger value="staff" className="data-[state=active]:border-b-2 data-[state=active]:border-indigo-600 rounded-none h-full px-6 data-[state=active]:shadow-none data-[state=active]:bg-transparent font-bold">本店员工排行</TabsTrigger>
            <TabsTrigger value="store" className="data-[state=active]:border-b-2 data-[state=active]:border-indigo-600 rounded-none h-full px-6 data-[state=active]:shadow-none data-[state=active]:bg-transparent font-bold">区域门店全榜</TabsTrigger>
            <TabsTrigger value="my-store" className="data-[state=active]:border-b-2 data-[state=active]:border-indigo-600 rounded-none h-full px-6 data-[state=active]:shadow-none data-[state=active]:bg-transparent font-bold">本店效能档案</TabsTrigger>
          </TabsList>
                ...
                <div className="flex flex-col h-full animate-in fade-in slide-in-from-right-4 duration-300 border border-slate-100 rounded-xl p-4 shadow-sm bg-white">
                   ...
                   <div className="flex items-center space-x-4 mb-6 px-2">
                      ...
                      <div>
                         ...
                         <p className="text-xs text-slate-500">Toko Mal Kelapa Gading | 编制 BA</p>
                      </div>
                   </div>
                           ...
                           <div className="space-y-4 flex-1">
                             <div className="bg-slate-50/50 p-3 rounded-lg border border-slate-100">
                               <div className="flex justify-between text-xs mb-2">
                                 <span className="text-slate-500 font-medium">本月完课率</span>
                                 <span className="font-bold text-slate-700">{selectedStaff === 'Cintya' ? '100' : selectedStaff === 'Eka' ? '90' : selectedStaff === 'Putri' ? '85' : selectedStaff === 'Lestari' ? '60' : '37'}%</span>
                               </div>
                               <Progress value={selectedStaff === 'Cintya' ? 100 : selectedStaff === 'Eka' ? 90 : selectedStaff === 'Putri' ? 85 : selectedStaff === 'Lestari' ? 60 : 37} className="h-1.5 [&>div]:bg-indigo-500" />
                             </div>
                             <div className="bg-slate-50/50 p-3 rounded-lg border border-slate-100">
                               <div className="flex justify-between text-xs mb-2">
                                 <span className="text-slate-500 font-medium">最近考试成绩</span>
                                 <span className={`font-bold ${selectedStaff === 'Rina' || selectedStaff === 'Lestari' ? 'text-rose-600' : 'text-slate-700'}`}>
                               ...
                               <div className="text-[10px] text-slate-400 mt-1 flex items-center font-medium">
                                 本月个人排名：<span className="ml-1 text-slate-600 font-bold">#{selectedStaff === 'Cintya' ? '1' : selectedStaff === 'Eka' ? '2' : selectedStaff === 'Putri' ? '3' : selectedStaff === 'Lestari' ? '4' : '5'}</span>
                               </div>
                             </div>
                           </div>
                         </div>
                           ...
                           <div className="space-y-3 text-sm flex-1">
                             <div className="bg-slate-50/50 p-3 rounded-lg border border-slate-100 h-full">
                               <div className="flex justify-between items-center border-b border-slate-200/60 pb-3 mb-3">
                                 <span className="text-slate-500 text-xs font-medium">本月对练达标</span>
                                 <span className="font-bold text-slate-800">{selectedStaff === 'Cintya' || selectedStaff === 'Eka' || selectedStaff === 'Putri' ? '已达标' : '未达标'}</span>
                               </div>
                               <div className="flex justify-between items-center border-b border-slate-200/60 pb-3 mb-3">
                                 <span className="text-slate-500 text-xs font-medium">剧本练习进度</span>
                                 <span className="font-bold text-slate-800">{selectedStaff === 'Cintya' ? '5/5' : selectedStaff === 'Eka' ? '4/5' : selectedStaff === 'Putri' ? '2/5' : '0/5'}</span>
                               </div>
                               <div className="flex justify-between items-center">
                                 <span className="text-slate-500 text-xs font-medium">表现评价</span>
                                 <span className={`font-bold ${selectedStaff === 'Cintya' || selectedStaff === 'Eka' ? 'text-green-600' : selectedStaff === 'Putri' ? 'text-slate-600' : 'text-rose-500'}`}>
                         ...
                         <div className="bg-orange-50/30 border border-orange-100 rounded-xl p-4 relative overflow-hidden group">
                            ...
                            <p className="text-xs text-slate-700 leading-relaxed">
                              {selectedStaff === 'Cintya' || selectedStaff === 'Eka' ? 
                                <>该员工近期陪练频率平稳，知识点覆盖率极高（<span className="font-bold text-green-600">95%+</span>）。<span className="text-slate-500 mt-2 block border-t border-orange-100 pt-2">建议鼓励其向新人分享学习方法，甚至在早会中担任一次临时讲师，通过输出巩固知识。</span></> : 
                                <>根据近期错题统计，该员工的知识盲区主要集中在<span className="font-bold text-slate-800">「夏季新品系列」</span>。其中涉及<span className="bg-white shadow-sm px-1 border border-orange-100 rounded text-[10px] font-mono mx-1">焕白精华适用肤质</span>的考题错误率最高。<span className="text-slate-500 mt-2 block border-t border-orange-100 pt-2">建议在接下来的早会抽查中，针对此员工专门提问几道此知识点的内容进行夯实巩固。</span></>}
                            </p>
                         </div>
                      </div>
                   </div>
                ...
                <div className="flex flex-col h-full bg-white border border-slate-100 rounded-xl shadow-sm overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                   <CardHeader className="p-4 border-b border-slate-50 bg-slate-50/50">
                      <CardTitle className="text-sm font-bold text-slate-800 flex justify-between items-center">
                        <span className="flex items-center"><User className="h-4 w-4 mr-2 text-indigo-500"/> 本店员工学习力排名</span>
                      </CardTitle>
                      <CardDescription className="text-[10px] uppercase tracking-widest mt-1">点击员工姓名查看档案细节</CardDescription>
                    </CardHeader>
                    <CardContent className="p-0 overflow-y-auto flex-1">
                       <table className="w-full text-sm">
                        <thead className="bg-slate-50/50 text-slate-400 text-[10px] uppercase tracking-wider text-left border-y border-slate-100 sticky top-0 z-10">
                          <tr>
                        ...
                        <tbody className="divide-y divide-slate-50">
                          <tr className="hover:bg-slate-50 transition-colors group cursor-pointer" onClick={() => handleStaffClick('Cintya')}>
                            <td className="py-3 px-5 font-bold text-amber-500 text-center">1</td>
                            <td className="py-3 px-4 font-bold text-slate-800 group-hover:text-indigo-600 transition-colors">Cintya</td>
                            <td className="py-3 px-2">
                               <div className="flex items-center space-x-2">
                                 <Progress value={100} className="h-1.5 w-16 [&>div]:bg-green-500" />
                          ...
                          <tr className="hover:bg-slate-50 transition-colors group cursor-pointer" onClick={() => handleStaffClick('Eka')}>
                            ...
                            <td className="py-3 px-4 font-bold text-slate-800 group-hover:text-indigo-600 transition-colors">Eka</td>
                            <td className="py-3 px-2">
                               <div className="flex items-center space-x-2">
                                 <Progress value={90} className="h-1.5 w-16 [&>div]:bg-blue-500" />
                          ...
                          <tr className="hover:bg-slate-50 transition-colors group cursor-pointer" onClick={() => handleStaffClick('Putri')}>
                            ...
                            <td className="py-3 px-2">
                               <div className="flex items-center space-x-2">
                                 <Progress value={85} className="h-1.5 w-16 [&>div]:bg-blue-500" />
                          ...
                          <tr className="hover:bg-slate-50 transition-colors group cursor-pointer" onClick={() => handleStaffClick('Lestari')}>
                            ...
                            <td className="py-3 px-4 font-bold text-slate-800 group-hover:text-amber-600 transition-colors">Lestari</td>
                            <td className="py-3 px-2">
                               <div className="flex items-center space-x-2">
                                 <Progress value={60} className="h-1.5 w-16 [&>div]:bg-amber-500" />
                           ...
                           <tr className="hover:bg-rose-50/50 transition-colors group cursor-pointer bg-rose-50/20" onClick={() => handleStaffClick('Rina')}>
                            ...
                            <td className="py-3 px-2">
                               <div className="flex items-center space-x-2">
                                 <Progress value={37} className="h-1.5 w-16 [&>div]:bg-rose-500" />
          ...
          <TabsContent value="store" className="pt-4 flex-1 outline-none">
             <Card className="flex flex-col h-full bg-white border border-slate-100 rounded-xl shadow-sm overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                <CardHeader className="p-4 border-b border-slate-50 bg-slate-50/50">
                <CardTitle className="text-sm font-bold text-slate-800 flex justify-between items-center">
                  <span className="flex items-center"><Building className="h-4 w-4 mr-2 text-indigo-500" /> 区域门店全榜 (只读展示)</span>
                </CardTitle>
                 ...
                 <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-slate-50">
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="py-3 px-5 font-bold text-amber-500 text-center">1</td>
                      <td className="py-3 px-4 font-bold text-slate-800">Toko Senayan City</td>
                    ...
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="py-3 px-5 font-bold text-slate-400 text-center">2</td>
                      <td className="py-3 px-4 font-bold text-slate-800">Toko Pacific Place</td>
                    ...
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="py-3 px-5 font-bold text-amber-700 text-center">3</td>
                      <td className="py-3 px-4 font-bold text-slate-800">Toko Gandaria City</td>
                    ...
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="py-3 px-5 font-bold text-slate-400 text-center">4</td>
                      <td className="py-3 px-4 font-bold text-slate-800">Toko Pondok Indah</td>
                    ...
                    <tr className="bg-indigo-50/50 border-l-2 border-l-indigo-500 hover:bg-indigo-50 transition-colors">
                      <td className="py-3 px-5 font-bold text-indigo-500 text-center">5</td>
                      <td className="py-3 px-4 font-bold text-indigo-700 flex items-center">
                        Toko Mal Kelapa Gading 
                        <Badge className="ml-2 px-1 py-0 text-[9px] bg-indigo-500 text-white border-none rounded">本店</Badge>
                      </td>
                      <td className="py-3 px-2 text-[10px] text-slate-500 hidden sm:table-cell text-center font-mono">5/5</td>
                      <td className="py-3 px-3 text-center font-medium text-slate-700">62%</td>
                      <td className="py-3 px-5 text-right font-bold text-indigo-600 text-base">71.4</td>
                    </tr>
                  </tbody>
                </table>
              </CardContent>
          ...
          <TabsContent value="my-store" className="pt-4 flex-1 outline-none">
             <Card className="h-full flex flex-col border-none shadow-none">
                <div className="flex flex-col h-full animate-in fade-in slide-in-from-right-4 duration-300 border border-slate-100 rounded-xl p-4 shadow-sm bg-white">
                   <div className="flex items-center space-x-4 mb-6 px-2">
                       <div className="h-12 w-12 rounded-xl bg-indigo-50 border border-indigo-100 flex items-center justify-center shrink-0 shadow-sm shadow-indigo-100">
                         <Building className="h-6 w-6 text-indigo-600" />
                       </div>
                       <div>
                         <h3 className="text-lg font-bold text-slate-800">Toko Mal Kelapa Gading</h3>
                         <p className="text-xs text-slate-500 mt-1">店长: 您 <span className="mx-1 text-slate-300">|</span> 编制 BA: <span className="font-bold text-slate-700">5 名</span> <span className="mx-1 text-slate-300">|</span> 区域排名: <span className="font-bold text-rose-500">倒数第一</span></p>
                       </div>
                   </div>
                   ...
                   <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
                      ...
                      <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 shadow-sm text-center">
                       ...
                       <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 shadow-sm text-center">
                         ...
                         <p className="text-2xl font-bold text-emerald-600">1<span className="text-xs text-emerald-500 font-medium ml-1">人</span></p>
                      </div>
                      <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 shadow-sm text-center border-b-2 border-b-rose-400">
                    ...
                    <div className="border border-slate-100 rounded-xl pt-0 overflow-hidden flex-1 flex flex-col bg-slate-50/50">
                      ...
                      <div className="p-4 space-y-4 flex-1">
                        <div className="flex flex-wrap gap-2">
                           ...
                           <Badge className="bg-slate-200 text-slate-700 hover:bg-slate-300 border-none px-3 py-1 text-xs">员工学习进度断层严重</Badge>
                        </div>
                         <div className="text-xs text-slate-600 mt-2 leading-relaxed bg-white border border-slate-200 shadow-sm p-4 rounded-xl relative">
                           ...
                           <br/><span className="mt-1 block text-slate-500">此种情况通常由未及时向员工下发培训要求、或未进行带教抽测导致。建议您尽快在本周内组织一次「全员新品专场内训及通关验收」。</span>
                         </div>
                      </div>
                    </div>
                </div>
