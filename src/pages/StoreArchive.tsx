               ...
               <table className="w-full text-left text-sm">
                 <thead className="bg-[#F8F5F3]/80 sticky top-0 border-b border-[#E9E4DF]">
                   <tr>
                     ...
                     <th className="p-4 font-bold text-[#766F73] w-32">岗位</th>
                 ...
                 <tbody className="divide-y divide-slate-50">
                    {storeData.employees.map((emp: any) => (
                      <tr key={emp.id} className="hover:bg-[#F8F5F3]/50 transition-colors">
                        ...
                        <td className="p-4">
                           <Badge variant="secondary" className="bg-slate-100 text-[#5D565A] font-normal hover:bg-[#F1ECE8]">{emp.position}</Badge>
                        </td>
                        <td className="p-4">
